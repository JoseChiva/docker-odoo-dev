...
class AurbHdtOutcomingPaymentsTraceability(models.Model):
    _name = "aurb.hdt.outcoming.payments.traceability"
    _description = "AURB outcoming Payments Traceability"
    _rec_name = "name"
