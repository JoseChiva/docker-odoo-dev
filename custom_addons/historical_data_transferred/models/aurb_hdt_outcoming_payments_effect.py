...
class AurbHdtOutcomingPaymentsEffect(models.Model):
    _name = "aurb.hdt.outcoming.payments.effect"
    _description = "AURB outcoming Payments effect"
    _rec_name = "name"
