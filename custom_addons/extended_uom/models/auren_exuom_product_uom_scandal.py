...
class AurenExUomProductUomScandal(models.Model):
    _name = "auren.exuom.product.uom.scandal"
    _description = "Auren Product Uom scandal"

    product_id = fields.Many2one("product.template")
    uom_id = fields.Many2one("uom.uom",
                             required=True,
                             help="Default unit of measure used for scandal orders. It must be in the same category as the default unit of measure.")
