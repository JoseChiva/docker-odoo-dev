    ...
    def _get_view(self, view_id=None, view_type='form', **options):
        ...
        if view_type == 'form':
            ...
            name_head_var1 = parameters.get_param(
                'auren_otools.desc_group_head_extended_discount_1')
            ...
            name_head_var2 = parameters.get_param(
                'auren_otools.desc_group_head_extended_discount_2')
            ...
            name_head_var3 = parameters.get_param(
                'auren_otools.desc_group_head_extended_discount_3')
            ...
            name_head_var4 = parameters.get_param(
                'auren_otools.desc_group_head_extended_discount_4')
            ...
            name_head_var5 = parameters.get_param(
                'auren_otools.desc_group_head_extended_discount_5')
            ...
            name_head_var6 = parameters.get_param(
                'auren_otools.desc_group_head_extended_discount_6')
